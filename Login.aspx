<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="On.Login" %>
...
<nav class="navbar fixed-top navbar-expand-md flex-nowrap navbar-new-top">
    ...
    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" required></asp:TextBox>
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox1" ForeColor="red" ErrorMessage="example@organisation.xxx" ValidationExpression="\w+@\w+\.\w+"></asp:RegularExpressionValidator>
                                ...
                                <a href="ForgotPass.aspx" class="text-info"<>Forgot Password?</a>
                            </div>
                            <div class="form-group">
                                <label for="password" class="text-info text-right">Password:</label><br/>
                                <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" required TextMode="Password"></asp:TextBox>
                            </div>
                            <div class="form-group">
               
        <asp:Button ID="Button1" runat="server" Text="Log in" CssClass="btn btn-info btn-md text-center" OnClick="Button1_Click" /><br />
        <asp:Label ID="Label1" runat="server" Text=""></asp:Label>
                               
                            </div>
                            <div id="register-link" class="text-right">
                                <a href="Sign.aspx" class="text-info">Register here</a>
                            </div>
                        </form>
                    </div>
                </div>
