<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLog.aspx.cs" Inherits="On.AdminLog" %>
...
<nav class="navbar fixed-top navbar-expand-md flex-nowrap navbar-new-top">
    ...
    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" required></asp:TextBox>
        ...
        <asp:Button ID="Button1" runat="server" Text="Log in" CssClass="btn btn-info btn-md text-center" OnClick="Button1_Click" />
