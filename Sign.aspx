<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign.aspx.cs" Inherits="On.Sign" %>
...
<nav class="navbar fixed-top navbar-expand-md flex-nowrap navbar-new-top">
    ...
    <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" required></asp:TextBox>
                                     <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox3" ForeColor="red" ErrorMessage="example@organisation.xxx" ValidationExpression="\w+@\w+\.\w+"></asp:RegularExpressionValidator>
                            </div>
                            <div class="form-group">
                                <label for="password" class="text-info">Password:</label><br/>
                                <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" TextMode="Password" required></asp:TextBox>
                            </div>
                              <div class="form-group">
                                <label for="password" class="text-info">Confirm Password:</label><br/>
                                <asp:TextBox ID="TextBox5" runat="server" CssClass="form-control" TextMode="Password" required></asp:TextBox>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Passwords don't match" ForeColor="Red" ControlToCompare="TextBox4" ControlToValidate="TextBox5"></asp:CompareValidator>
                            </div>
                            <div class="form-group">
               
        <asp:Button ID="Button1" runat="server" Text="Register" CssClass="btn btn-info btn-md text-center" OnClick="Button1_Click" />
                                <br />
                                <asp:Label ID="Label1" runat="server" Text=""></asp:Label>
                               
                            </div>
                            <div id="register-link" class="text-right">
                                <a href="Login.aspx" class="text-info">Already have an account?</a>
                            </div>
                        </form>
                    </div>
                </div>
